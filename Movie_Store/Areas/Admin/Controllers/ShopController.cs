using Movie_Store.Models.Data;
using Movie_Store.Models.ViewModels.Shop;
using System;
...
using PagedList;
using Movie_Store.Areas.Admin.Models.ViewModels.Shop;

namespace Movie_Store.Areas.Admin.Controllers
{
